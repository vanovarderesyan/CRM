const { SphereActivityQueries: query } = require('../../dao/queries/configs/sphere_activity.queries');
...
module.exports.SphereActivityDao = new SphereActivityDao();