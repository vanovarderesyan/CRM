const { AreasConductQueries: query } = require('../../dao/queries/configs/areas_conduct.queries');
...
module.exports.AreasConductDao = new AreasConductDao();