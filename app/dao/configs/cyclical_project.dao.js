const { CyclicalProjectQueries: query } = require('../../dao/queries/configs/cyclical_project.queries');
...
module.exports.CyclicalProjectDao = new CyclicalProjectDao();