"use strict";
const { TypeProjectDao: dao } = require("../../../dao/configs/type_project.dao");

class TypeProjectController {
    signUp(req, res) {
...
module.exports.TypeProjectController = new TypeProjectController();
