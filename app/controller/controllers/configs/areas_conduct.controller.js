"use strict";
const { AreasConductDao: dao } = require("../../../dao/configs/areas_conduct.dao");

class AreasConductController {
    signUp(req, res) {
...
module.exports.AreasConductController = new AreasConductController();
