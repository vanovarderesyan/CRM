const { DepartmentManagereQueries: query } = require('./queries/department-manager.queries');
...
class DepartmentManagereDao {
    signUp(data) {
        return new Promise((resolve, reject) => {
            const conditions = [data.DepartmentId, data.ManagerId];
...
module.exports.DepartmentManagereDao = new DepartmentManagereDao();