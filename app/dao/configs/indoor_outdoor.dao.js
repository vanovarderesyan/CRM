const { IndoorOutdoorQueries: query } = require('../../dao/queries/configs/indoor_outdoor.queries');
...
module.exports.IndoorOutdoorDao = new IndoorOutdoorDao();