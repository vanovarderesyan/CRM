const { FormatProjectQueries: query } = require('../../dao/queries/configs/format_project.queries');
...
module.exports.FormatProjectDao = new FormatProjectDao();